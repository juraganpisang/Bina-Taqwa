            ...
            ?>
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <div class="popular-course-thumb bg-img" style="background-image: url(<?php echo base_url() ?>/assets/img/news/<?php echo $item->foto ?>)"><a href="<?= base_url(); ?>berita/detail_berita/<?php echo $item->id_news ?>">
                        </div>
